...
🧭 How It Works
Upload — Student uploads syllabus, PYQs, and notes.
Input Time Remaining — Student specifies how much time is left before the exam.
Analyze — The system parses the documents, identifies high-frequency and high-weightage topics, and cross-references them with the syllabus.
Generate Plan — Based on time remaining, the app builds a tiered, timestamped revision timeline:
...
Quiz — Student takes a short auto-generated quiz to validate their prep before the exam.
🖥️ Tech Stack
...
📁 Usage
Go to the homepage and upload your syllabus, notes, and PYQ files.
Enter the number of hours/days remaining before your exam.
Click Generate Plan.
Navigate through the tabs: Exam ROI, Priority Timeline, Skip For Now, Ultra-Short Notes, Formulas & PYQs, and 5-Min Cheat Sheet.
Finish with the Quiz tab to test yourself.
🗺️ Roadmap
